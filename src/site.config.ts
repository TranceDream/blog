...
const config: SiteConfig = {
  ...
  site: 'https://tranced.moe',
  // The name of your site, used in the title and for SEO.
  title: 'TranceDream\'s Blog',
  ...
  tags: ['Blog', 'TranceDream', 'TranceDream\'s Blog', 'tranced.moe'],
  // Path to the image used for generating social media previews.
  // Needs to be a square JPEG file due to limitations of the social card generator.
  // Try https://squoosh.app/ to easily convert images to JPEG.
  socialCardAvatarImage: './src/content/avatar.webp',
  // Font imported from vite-plugin-font, used for the entire site.
  // The actual font name is set in Layout.astro via font import.
  // This value is kept for backward compatibility but may not be used.
  font: 'Maple Mono',
  ...
  giscus: {
    repo: 'TranceDream/blog',
    repoId: 'R_kgDONs4WsQ',
    category: 'Giscus',
    categoryId: 'DIC_kwDONs4Wsc4C1RNp',
  ...
  characters: {
    pusheen: '/pusheen.webp',
    'handshake-pusheen': '/handshake-pusheen.webp',
  },
}
