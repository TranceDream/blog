...
const components = {
  ...
  hr: (props: any) => <hr className="my-8 border-muted-foreground/20" {...props} />,
  table: (props: any) => (
  ...
  pre: (props: any) => <pre className="mb-4 mt-6 overflow-x-auto rounded-lg border bg-black py-4" {...props} />,
  code: (props: any) => {
    // 检查是否是代码块
    ...
    // 内联代码
    return <code className="relative rounded border px-[0.3rem] py-[0.2rem] font-mono text-sm" {...props} />
  },
}
...
export function MarkdownContent({ content }: MarkdownContentProps) {
  ...
  return <div className="prose dark:prose-invert max-w-none">{processedContent}</div>
}